...
<head>
   <meta charset="UTF-8">
		...
		<!-- Favicon -->
		<link rel="icon" type="image/png" sizes="56x56" href="https://wallpapercave.com/wp/wp4720659.jpg">
...
<div class="main-page-wrapper">
			...
			<header class="theme-main-header">
				<div class="container">
						<!-- ========================= Add your logo ======================= -->
					<a href="index.html" class="logo float-left tran4s"><img src="https://upload.wikimedia.org/wikipedia/commons/6/6a/Jujutsu_Kaisen_logo_in_Japan.png" alt="Logo" ></a> 
					...
					<!--		<li><a href="index.html#project-section">SOCI</a></li>-->
							...
							<li class="dropdown-holder"><a href="academics.html">ACADEMICS</a></li>
...
<table class="responsivetable">
					...
					<tbody id = "GbpecTable">
					  <tr>
						<td><strong>07/06/22</strong></td>
						<td class = "academics">academics</td>
						<td>College time table</td>
					  </tr>
					  <tr>
						<td><strong>05/06/2022</strong></td>
						<td class = "Financial">Financial</td>
						<td>Financial Aid notice </td>
					  </tr>
					  <tr>
						<td><strong>29/05/2022</strong></td>
						<td class = "Schlorship">Schlorship</td>
						<td><a href="https://scholarships.gov.in/" class="tran3s active"><i class="Schlorship" aria-hidden="true"></i>Some scholarship notice</a></td> 
					  </tr>
					</tbody>
				  </table>
